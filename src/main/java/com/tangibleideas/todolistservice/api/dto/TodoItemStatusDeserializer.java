...
public class TodoItemStatusDeserializer extends JsonDeserializer<TodoItemStatus> {
  ...
  @Override
  public TodoItemStatus deserialize(JsonParser p, DeserializationContext ctx) throws IOException {
    ...
    String errorMessage = "Expected one of " + allowedValues + ", received " + value;
