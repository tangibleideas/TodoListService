...
public class TodoItemController {
  ...
  @PostMapping
  public ResponseEntity<TodoItemDTO> addTodoItem(@Valid @RequestBody AddTodoItemRequest todoItem) {
  ...
  public ResponseEntity<TodoItemDTO> updateTodoItem(
      @PathVariable Long id, @Valid @RequestBody UpdateTodoItemRequest todoItem) {
    return todoItemService
